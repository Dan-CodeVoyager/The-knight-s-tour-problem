...
class TrainPipeline:
    ...
    def policy_evaluate(self, n_games=10):  # n=10
        """
        ...
        for i in range(n_games):
            # w = self.game.start_play(current_mcts_player, pure_mcts_player, start_player=(i%2))
    ...
    def run(self):
        ...
        try:
            ...
            plt.title("Effectiveness over self-play games")
            plt.show()
